...
import book from "./mock-book.png"
        ...
        <div className="main-middle">
            <div className="course-box">
                ...
                <div className="course-buy-box">
                    ...
                    <a className="button-text-1" target="_blank" href="https://whop.com/monk-mode-movement  "><button className="button-course">Buy</button></a>
